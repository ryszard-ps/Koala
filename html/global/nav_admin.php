  ...
  <ul class="nav navbar-top-links navbar-right">
    <li class="dropdown">
      ...
      <ul class="dropdown-menu dropdown-user">
        ...
        <li>
          <a href="?vista=salir"><i class="fa fa-sign-out fa-fw"></i> Salir</a>
        </li>
      </ul>
    </li>
  </ul>
    ...
    <div class="sidebar-nav navbar-collapse">
      ...
      <!--  <li>
          ...
          <ul class="nav nav-second-level">
            ...
            <li>
              <a href="#">Asignar Empleado</a>
            </li>
          </ul>
        </li>
        <li>
          <a href="#"><i class="fa fa-sitemap fa-fw"></i> Organización<span class="fa arrow"></span></a>
          <ul class="nav nav-second-level">
            <li>
              <a href="#">Ver Zonas</a>
            </li>
            <li>
              <a href="#">Agregar Zonas</a>
            </li>
          </ul>
        </li>
        <li>
          <a href="#">
            <i class="fa fa-bar-chart-o fa-fw"></i> Estadisticas<span class="fa arrow"></span>
          </a>
          <ul class="nav nav-second-level">
            <li>
              <a href="#">Vistos</a>
